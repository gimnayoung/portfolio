            ...
            <ModalWrap>
                ...
                <ContentBox>
                    <Left>
                        ...
                        <FontBox>
                            <Font>💡 스택오버플로우</Font>
                            <Font fontSize={'15px'} color={'#505050'}>프로그래밍과 소프트웨어 개발 관련된 질문과 답변을 공유하고 
토론하는 커뮤니티 기반의 웹사이트"Stack Overflow"를 클론코딩한 팀 프로젝트 입니다.</Font>
                        </FontBox>
                        <FontBox>
                            <Font>🔎 바로가기</Font>
                            <Font fontSize={'12px'} color={'#505050'}>* 배포하였으나 기간이 만료 되었습니다.</Font>
                    ...
                    <Right>
                        ...
                        <SubFont>-로그인 했을때와 로그아웃을 했을때 Zustand 상태관리 라이브러리를 이용하여 Header 가 변할 수 있도록 구현했습니다.</SubFont>
                        <Font fontSize={'13px'} color={'#505050'}>[Login Header]</Font>
                        <SmallWrap marginTop={'4px'}>
                            <SmallLeft>
                             <Img src={Img6}></Img>
                            </SmallLeft>
                        </SmallWrap>
                        <Font fontSize={'13px'} color={'#505050'}>[Logout Header]</Font>
                        <SmallWrap marginTop={'4px'}>
                            <SmallLeft>
                             <Img src={Img4}></Img>
                            </SmallLeft>
