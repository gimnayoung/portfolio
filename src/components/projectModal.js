            ...
            <ModalWrap>
                ...
                <ContentBox>
                    <Left>
                        ...
                        <FontBox>
                            <Font>💡 포트폴리오</Font>
                            <Font fontSize={'15px'} color={'#505050'}>포트폴리오 사이트 입니다.</Font>
                        </FontBox>
                        <FontBox>
                            <Font>🙋‍♀️ 페이지</Font>
                            <Font fontSize={'15px'} color={'#505050'}>홈 페이지</Font>
                            <Font fontSize={'15px'} color={'#505050'}>프로젝트 페이지</Font>
                            <Font fontSize={'15px'} color={'#505050'}>스킬 페이지</Font>
                            <Font fontSize={'15px'} color={'#505050'}>콘텍트 페이지</Font>
                        </FontBox>
                        <FontBox>
                            <Font>🔎 바로가기</Font>
                            <A href='https://gimnayoung.github.io/react' fontSize={'14px'} color={'gray'}>PortFolio</A>
