    ...
    <ProjectWrap>
      ...
      <Wrap>
        <ProjectBox theme={ThemeMode[0]} onClick={HandleModal4}>
          ...
          <Hh>
            <Text font_size={"18px"} color={"white"} font_weight={"700"}>
              팀 프로젝트
            </Text>
          </Hh>
          <Bot>
        ...
        <ProjectBox theme={ThemeMode[0]} onClick={HandleModal3}>
          ...
          <Bot>
            ...
            <Text>
              즐겨찾는 의류상품을 한눈에 볼 수 있는 나만의 쇼핑몰 입니다.
            </Text>
            <Title>🔨 사용스택</Title>
            <SkillWrap>
              <SkillBox>
        ...
        <ProjectBox theme={ThemeMode[0]} onClick={HandleModal2}>
          ...
          <Bot>
            <Title>💡 스택오버플로우</Title>
            <Text>
              커뮤니티 기반의 웹 사이트 "스택오버플로우" 클론코딩 한 프로젝트
              입니다.
            </Text>
            <Title>🔨 사용스택</Title>
            <SkillWrap>
        ...
        {openModal2 && (
          <ProjectModal2 setCloseModal2={setCloseModal2}></ProjectModal2>
        )}
        {openModal3 && (
          <ProjectModal3 setCloseModal3={setCloseModal3}></ProjectModal3>
        )}
        {openModal4 && (
          <ProjectModal4 setCloseModal4={setCloseModal4}></ProjectModal4>
        )}
      </Wrap>
    </ProjectWrap>
  );
